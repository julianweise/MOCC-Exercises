...
def main():
    ...
    if args.action == 'init':
        ...
        container.run(args.namespace, args.limit, args.executable, args.executable_args)
...
def _initialize_run_parser(subparsers):
    ...
    run_parser.add_argument('--namespace', type=str, help='Define a namespace to join: Format: <kind>=<pid>', action='append')
